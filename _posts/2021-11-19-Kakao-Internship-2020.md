...
위의 예시에서는 다음과 같이 정리될 수 있을 것이다: ["RUBY": 2, "DIA": 7, "EMERALD": 5, "SAPHIRE": 6]

또, 동시에 가장 빨리 택한다면 언제 택할 수 있을지 미리 스캔을 해보면 다음과 같을 것이다: ["RUBY": 1, "DIA": 0, "EMERALD": 5, "SAPHIRE": 6]

따라서, 두 리스트 [1, 0, 5, 6]과 [2, 7, 5, 6] 각각에서 최댓값과 최솟값을 택하면 답이 나오는 것이다. 
